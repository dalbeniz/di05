...
export class Tab1Page implements OnInit {
  ...
  addHeader(doc:jsPDF){
    ...
    doc.rect(5,5,doc.internal.pageSize.getWidth() - 10, imgHeight,'F');
    doc.addImage(imagen, "JPG", doc.internal.pageSize.width/2, imgY, imgWidth, imgHeight);
   ...
   * @param page 
   */
  addFooter(doc:jsPDF, page: number){
    let texto = "Página " + page + " de " +doc.getNumberOfPages();
    doc.setFillColor('#CCCCCC');
    doc.rect(10,doc.internal.pageSize.height - 20,doc.internal.pageSize.getWidth() - 10, 10,'F');
    doc.text( texto, doc.internal.pageSize.width/2, doc.internal.pageSize.height - 10, {baseline:'bottom'});
